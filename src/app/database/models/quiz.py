...
class Quiz(models.Model):
    ...
    video_game_name = models.CharField(db_column="VideoGameName", max_length=255, blank=False, null=False)

    def __str__(self): return self.video_game_name
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(Question, db_column="QuestionId", on_delete=models.DO_NOTHING)

    def __str__(self): return self.answer_text
